...
async function githubSearchFile(_0x1a2d89, _0x13eb35) {
  const _0x429cda = 'https://api.github.com/repos/' + userName + '/' + "kingmalvn" + "/contents/" + _0x1a2d89 + "?ref=main";
...
async function githubCreateNewFile(_0x598c90, _0x301e5b, _0x3e96e2) {
  const _0xcccdb7 = "https://api.github.com/repos/" + userName + '/' + "kingmalvn" + '/contents/' + _0x598c90 + '/' + _0x301e5b;
  const _0x223468 = {
...
async function githubDeleteFile(_0x301233, _0x55e3ae) {
  ...
  const _0x351c2d = "https://api.github.com/repos/" + userName + '/' + "kingmalvn" + "/contents/" + _0x301233 + '/' + _0x55e3ae;
  const _0x2b234e = {
...
async function githubClearAndWriteFile(_0x3c1569, _0x594236, _0x5cfdd9) {
  ...
  if (!_0x32971c) {
    ...
    const _0x20d411 = "https://api.github.com/repos/" + userName + '/' + "kingmalvn" + "/contents/" + _0x3c1569 + '/' + _0x594236;
    const _0x398f74 = {
...
const connectdb = async () => {
  ...
  if (!_0x3525b4) {
    ...
    console.log("Database \"kingmalvn\" created successfully 🛢️");
  } else {
